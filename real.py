    ...
    while package_queue:
        for package_id in package_queue:
            ...
            if package:
                ...
                # Fetch the distance between truck and next address
        ...
        if nextPackage:
            ...
            # After delivery, remove the package
...
#Loop array and check for zeroes. asert zeroes equal to length of the column for the perpendicular row. time complexity O(N^2), space complexity = o(n^2)
